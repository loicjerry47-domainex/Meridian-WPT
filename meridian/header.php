        ...
        <div class="container header-inner">
            <div class="site-branding">
                ...
                if ( has_custom_logo() ) {
                    ...
                    if ( $meridian_description || is_customize_preview() ) :
                        ?>
                        <p class="site-description"><?php echo $meridian_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
                    <?php endif;
                }
                ?>
            </div>
            ...
            <nav id="site-navigation" class="main-navigation">
                <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'meridian' ); ?></button>
                <?php
                wp_nav_menu( array(
            ...
            <div class="header-actions">
                <button id="dark-mode-toggle" class="dark-mode-btn" aria-label="<?php esc_attr_e( 'Toggle dark mode', 'meridian' ); ?>">
